...
#aaaaaaaaaaaakm
    mini_akm = GroupAction([
        launch_ros.actions.Node(
            ...
            arguments=[os.path.join(get_package_share_directory('mercury_robot_urdf'),'urdf','mini_akm_robot.urdf')],),
        launch_ros.actions.Node(
            package='tf2_ros', 
    ...
    senior_akm = GroupAction([
        ...
        launch_ros.actions.Node(
            ...
            executable='robot_state_publisher', 
            name='robot_state_publisher',
            arguments=[os.path.join(get_package_share_directory('mercury_robot_urdf'),'urdf','senior_akm_robot.urdf')],),
    ...
    top_akm_bs = GroupAction([
        launch_ros.actions.Node(
            ...
            executable='robot_state_publisher', 
            name='robot_state_publisher',
            arguments=[os.path.join(get_package_share_directory('mercury_robot_urdf'),'urdf','top_akm_bs_robot.urdf')],),
        launch_ros.actions.Node(
            package='tf2_ros', 
            executable='static_transform_publisher', 
            name='base_to_laser',
    ...
    top_akm_dl = GroupAction([
        launch_ros.actions.Node(
            ...
            executable='robot_state_publisher', 
            name='robot_state_publisher',
            arguments=[os.path.join(get_package_share_directory('mercury_robot_urdf'),'urdf','top_akm_dl_robot.urdf')],),
        launch_ros.actions.Node(
            package='tf2_ros', 
            executable='static_transform_publisher', 
            name='base_to_laser',
...
#mmmmmmmmmmmmmmmec
    ...
    mini_mec = GroupAction([
        launch_ros.actions.Node(
            ...
            executable='robot_state_publisher', 
            name='robot_state_publisher',
            arguments=[os.path.join(get_package_share_directory('mercury_robot_urdf'),'urdf','mini_mec_robot.urdf')],),
        launch_ros.actions.Node(
            package='tf2_ros', 
            executable='static_transform_publisher', 
            name='base_to_laser',
    ...
    senior_mec_bs = GroupAction([
        launch_ros.actions.Node(
            ...
            executable='robot_state_publisher', 
            name='robot_state_publisher',
            arguments=[os.path.join(get_package_share_directory('mercury_robot_urdf'),'urdf','senior_mec_robot.urdf')],),
        launch_ros.actions.Node(
            package='tf2_ros', 
            executable='static_transform_publisher', 
            name='base_to_laser',
    ...
    senior_mec_dl = GroupAction([
        launch_ros.actions.Node(
            ...
            executable='robot_state_publisher', 
            name='robot_state_publisher',
            arguments=[os.path.join(get_package_share_directory('mercury_robot_urdf'),'urdf','senior_mec_dl_robot.urdf')],),
        launch_ros.actions.Node(
            package='tf2_ros', 
            executable='static_transform_publisher', 
            name='base_to_laser',
    ...
    top_mec_bs = GroupAction([
        launch_ros.actions.Node(
            ...
            executable='robot_state_publisher', 
            name='robot_state_publisher',
            arguments=[os.path.join(get_package_share_directory('mercury_robot_urdf'),'urdf','top_mec_bs_robot.urdf')],),
        launch_ros.actions.Node(
            package='tf2_ros', 
            executable='static_transform_publisher', 
            name='base_to_laser',
    ...
    top_mec_dl = GroupAction([
        launch_ros.actions.Node(
            ...
            executable='robot_state_publisher', 
            name='robot_state_publisher',
            arguments=[os.path.join(get_package_share_directory('mercury_robot_urdf'),'urdf','top_mec_dl_robot.urdf')],),
        launch_ros.actions.Node(
            package='tf2_ros', 
            executable='static_transform_publisher', 
            name='base_to_laser',
    ...
    senior_mec_EightDrive = GroupAction([
        launch_ros.actions.Node(
            ...
            executable='robot_state_publisher', 
            name='robot_state_publisher',
            arguments=[os.path.join(get_package_share_directory('mercury_robot_urdf'),'urdf','mec_EightDrive_robot.urdf')],),
        launch_ros.actions.Node(
            package='tf2_ros', 
            executable='static_transform_publisher', 
            name='base_to_laser',
    ...
    flagship_mec_bs_robot = GroupAction([
        launch_ros.actions.Node(
            ...
            executable='robot_state_publisher', 
            name='robot_state_publisher',
            arguments=[os.path.join(get_package_share_directory('mercury_robot_urdf'),'urdf','flagship_mec_bs_robot.urdf')],),
        launch_ros.actions.Node(
            package='tf2_ros', 
            executable='static_transform_publisher', 
            name='base_to_laser',
    ...
    flagship_mec_dl_robot = GroupAction([
        launch_ros.actions.Node(
            ...
            executable='robot_state_publisher', 
            name='robot_state_publisher',
            arguments=[os.path.join(get_package_share_directory('mercury_robot_urdf'),'urdf','flagship_mec_dl_robot.urdf')],),
        launch_ros.actions.Node(
            package='tf2_ros', 
            executable='static_transform_publisher', 
            name='base_to_laser',
...
#oooooooooooooooooomi
    ...
    mini_omni = GroupAction([
        launch_ros.actions.Node(
            ...
            executable='robot_state_publisher', 
            name='robot_state_publisher',
            arguments=[os.path.join(get_package_share_directory('mercury_robot_urdf'),'urdf','mini_omni_robot.urdf')],),
        launch_ros.actions.Node(
            package='tf2_ros', 
            executable='static_transform_publisher', 
            name='base_to_laser',
    ...
    senior_omni = GroupAction([
        launch_ros.actions.Node(
            ...
            executable='robot_state_publisher', 
            name='robot_state_publisher',
            arguments=[os.path.join(get_package_share_directory('mercury_robot_urdf'),'urdf','senior_omni_robot.urdf')],),
        launch_ros.actions.Node(
            package='tf2_ros', 
            executable='static_transform_publisher', 
            name='base_to_laser',
    ...
    top_omni = GroupAction([
        launch_ros.actions.Node(
            ...
            executable='robot_state_publisher', 
            name='robot_state_publisher',
            arguments=[os.path.join(get_package_share_directory('mercury_robot_urdf'),'urdf','top_omni_robot.urdf')],),
        launch_ros.actions.Node(
            package='tf2_ros', 
            executable='static_transform_publisher', 
            name='base_to_laser',
...
#dddddddddddddddddddiff
    ...
    mini_tank = GroupAction([
        launch_ros.actions.Node(
            ...
            executable='robot_state_publisher', 
            name='robot_state_publisher',
            arguments=[os.path.join(get_package_share_directory('mercury_robot_urdf'),'urdf','mini_diff_robot.urdf')],),
        launch_ros.actions.Node(
            package='tf2_ros', 
            executable='static_transform_publisher', 
            name='base_to_laser',
...
#4444444444444444444wd
    mini_4wd = GroupAction([
        launch_ros.actions.Node(
            ...
            executable='robot_state_publisher', 
            name='robot_state_publisher',
            arguments=[os.path.join(get_package_share_directory('mercury_robot_urdf'),'urdf','mini_4wd_robot.urdf')],),
        launch_ros.actions.Node(
            package='tf2_ros', 
            executable='static_transform_publisher', 
            name='base_to_laser',
    ...
    senior_4wd_bs_robot = GroupAction([
        launch_ros.actions.Node(
            ...
            executable='robot_state_publisher', 
            name='robot_state_publisher',
            arguments=[os.path.join(get_package_share_directory('mercury_robot_urdf'),'urdf','senior_4wd_bs_robot.urdf')],),
        launch_ros.actions.Node(
            package='tf2_ros', 
            executable='static_transform_publisher', 
            name='base_to_laser',
    ...
    senior_4wd_dl_robot = GroupAction([
        launch_ros.actions.Node(
            ...
            executable='robot_state_publisher', 
            name='robot_state_publisher',
            arguments=[os.path.join(get_package_share_directory('mercury_robot_urdf'),'urdf','senior_4wd_dl_robot.urdf')],),
        launch_ros.actions.Node(
            package='tf2_ros', 
            executable='static_transform_publisher', 
            name='base_to_laser',
    ...
    flagship_4wd_bs_robot = GroupAction([
        launch_ros.actions.Node(
            ...
            executable='robot_state_publisher', 
            name='robot_state_publisher',
            arguments=[os.path.join(get_package_share_directory('mercury_robot_urdf'),'urdf','flagship_4wd_bs_robot.urdf')],),
        launch_ros.actions.Node(
            package='tf2_ros', 
            executable='static_transform_publisher', 
            name='base_to_laser',
    ...
    flagship_4wd_dl_robot = GroupAction([
        launch_ros.actions.Node(
            ...
            executable='robot_state_publisher', 
            name='robot_state_publisher',
            arguments=[os.path.join(get_package_share_directory('mercury_robot_urdf'),'urdf','flagship_4wd_dl_robot.urdf')],),
        launch_ros.actions.Node(
            package='tf2_ros', 
            executable='static_transform_publisher', 
            name='base_to_laser',
    ...
    top_4wd_bs_robot = GroupAction([
        launch_ros.actions.Node(
            ...
            executable='robot_state_publisher', 
            name='robot_state_publisher',
            arguments=[os.path.join(get_package_share_directory('mercury_robot_urdf'),'urdf','top_4wd_bs_robot.urdf')],),
        launch_ros.actions.Node(
            package='tf2_ros', 
            executable='static_transform_publisher', 
            name='base_to_laser',
    ...
    top_4wd_dl_robot = GroupAction([
        launch_ros.actions.Node(
            ...
            executable='robot_state_publisher', 
            name='robot_state_publisher',
            arguments=[os.path.join(get_package_share_directory('mercury_robot_urdf'),'urdf','top_4wd_dl_robot.urdf')],),
        launch_ros.actions.Node(
            package='tf2_ros', 
            executable='static_transform_publisher', 
            name='base_to_laser',
...
#dddddddddddddddddddiff
    ...
    senior_diff_robot = GroupAction([
        launch_ros.actions.Node(
            ...
            executable='robot_state_publisher', 
            name='robot_state_publisher',
            arguments=[os.path.join(get_package_share_directory('mercury_robot_urdf'),'urdf','senior_diff_robot.urdf')],),
        launch_ros.actions.Node(
            package='tf2_ros', 
            executable='static_transform_publisher', 
            name='base_to_laser',
    ...
    four_wheel_diff_bs = GroupAction([
        launch_ros.actions.Node(
            ...
            executable='robot_state_publisher', 
            name='robot_state_publisher',
            arguments=[os.path.join(get_package_share_directory('mercury_robot_urdf'),'urdf','four_wheel_diff_bs_robot.urdf')],),
        launch_ros.actions.Node(
            package='tf2_ros', 
            executable='static_transform_publisher', 
            name='base_to_laser',
    ...
    four_wheel_diff_dl = GroupAction([
        launch_ros.actions.Node(
            ...
            executable='robot_state_publisher', 
            name='robot_state_publisher',
            arguments=[os.path.join(get_package_share_directory('mercury_robot_urdf'),'urdf','four_wheel_diff_dl_robot.urdf')],),
    ...
    brushless_senior_diff = GroupAction([
        launch_ros.actions.Node(
            ...
            executable='robot_state_publisher', 
            name='robot_state_publisher',
            arguments=[os.path.join(get_package_share_directory('mercury_robot_urdf'),'urdf','mercury_x1','mercury_x1.urdf')],),
            
        launch_ros.actions.Node(
            package='tf2_ros', 
            executable='static_transform_publisher', 
            name='base_to_laser',
            arguments=['0.272', '0', '0.257','0.0', '0','0','base_footprint','laser'],),
        launch_ros.actions.Node(
            package='tf2_ros', 
            executable='static_transform_publisher', 
            name='base_to_camera',
    ...
    flagship_four_wheel_diff_bs_robot = GroupAction([
        launch_ros.actions.Node(
            ...
            executable='robot_state_publisher', 
            name='robot_state_publisher',
            arguments=[os.path.join(get_package_share_directory('mercury_robot_urdf'),'urdf','flagship_four_wheel_diff_bs_robot.urdf')],),
    ...
    flagship_four_wheel_diff_dl_robot = GroupAction([
        launch_ros.actions.Node(
            ...
            executable='robot_state_publisher', 
            name='robot_state_publisher',
            arguments=[os.path.join(get_package_share_directory('mercury_robot_urdf'),'urdf','flagship_four_wheel_diff_dl_robot.urdf')],),
    ...
    ld.add_action(brushless_senior_diff)
    return ld
